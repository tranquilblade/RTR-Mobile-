...
<table width="50%" border="0" align="center">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3" bgcolor="#FBD8C9" style="text-align: center; color: #000000;"><input type="button" name="button" id="button" value="OK" onClick="javascript:window.location='Guidance.php'" ></td>
  </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
